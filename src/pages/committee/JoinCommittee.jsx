  ...
  return (
    <AuthAmbientBackground showTicker={true}>
      <div className="w-full max-w-2xl mx-auto px-3 sm:px-6 py-4 sm:py-8 flex flex-col items-center justify-center min-h-[calc(100vh-36px)]">
        ...
        {/* Main Glass Card matching CreateCommittee design */}
        <main className="w-full bg-white rounded-2xl border border-[#006972]/15 shadow-[0_4px_20px_rgba(0,0,0,0.05)] overflow-hidden p-6 sm:p-10 animate-fade-up relative z-10">
          ...
          <section className="flex flex-col gap-2 mb-8">
            <h2 className="font-headline text-[28px] font-bold text-[#006972]">Diwali Savings Fund</h2>
            <p className="font-body text-[14px] text-on-surface-variant">Review the terms below before submitting your request to join.</p>
          </section>
          ...
          <button onClick={() => navigate('/join-request-sent')} className="w-full bg-[#000000] hover:bg-[#3a4859] text-[#ffffff] font-label text-[14px] py-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
            Request to Join
