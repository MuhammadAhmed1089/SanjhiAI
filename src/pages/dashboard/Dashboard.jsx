...
<img alt="Profile" className="w-10 h-10 rounded-full object-cover border border-outline-variant/60" src="/avatar.svg" />
<h1 className="font-headline text-[24px] leading-[32px] font-bold text-on-surface">Hi, Anika</h1>
</div>
<button onClick={() => navigate('/notifications')} aria-label="Notifications" className="relative text-on-surface-variant hover:bg-surface-container-low transition-colors p-2 rounded-full active:scale-95 duration-150">
...
<a onClick={() => navigate('/payments')} className="font-label text-[14px] leading-[20px] font-semibold text-primary hover:underline underline-offset-4 cursor-pointer" href="#">View All</a>
</div>
<div onClick={() => navigate('/committee/1')} className="bg-surface rounded-2xl p-6 border-2 border-white/50 shadow-[8px_8px_16px_rgba(0,0,0,0.05),-8px_-8px_16px_rgba(255,255,255,0.8)] hover:shadow-lg transition-all cursor-pointer group mb-4">
...
<span onClick={() => navigate('/committee/1')} className="font-label text-[14px] leading-[20px] font-semibold text-primary group-hover:underline underline-offset-4 cursor-pointer">Manage</span>
</div>
</div>

<div onClick={() => navigate('/committee/2')} className="bg-surface rounded-xl p-6 border border-outline-variant/60 shadow-[0_2px_16px_rgba(15,28,44,0.04)] hover:shadow-md transition-shadow cursor-pointer group">
<div className="flex items-start justify-between mb-4">
<div className="flex items-center gap-4">
...
<span onClick={() => navigate('/payments/pay')} className="font-label text-[14px] leading-[20px] font-semibold text-primary group-hover:underline underline-offset-4 cursor-pointer">Pay Now</span>
</div>
</div>
</section>
...
<button onClick={() => navigate('/committee/create')} className="bg-primary/90 backdrop-blur-sm text-on-primary rounded-2xl p-6 flex flex-col items-center justify-center gap-3 hover:bg-primary transition-all shadow-[0_8px_32px_rgba(15,28,44,0.3)] active:scale-95 duration-150 border border-white/20">
<span className="material-symbols-outlined text-[32px]">add_circle</span>
<span className="font-headline text-[18px] leading-[28px] font-medium">Create Committee</span>
</button>
<button onClick={() => navigate('/join')} className="bg-surface text-primary rounded-2xl p-6 flex flex-col items-center justify-center gap-3 border-2 border-primary/20 hover:bg-primary/5 transition-all shadow-[6px_6px_12px_rgba(0,0,0,0.05),-6px_-6px_12px_rgba(255,255,255,0.8)] active:scale-95 duration-150">
...
<a onClick={() => navigate('/dashboard')} className="flex flex-col items-center justify-center bg-primary text-on-primary rounded-full px-5 py-1.5 transition-all active:scale-90 duration-200 cursor-pointer" href="#">
...
<a onClick={() => navigate('/committee/1')} className="flex flex-col items-center justify-center text-on-surface-variant opacity-70 hover:text-primary transition-opacity active:scale-90 duration-200 cursor-pointer" href="#">
<span className="material-symbols-outlined">groups</span>
<span className="font-label text-[12px] tracking-wide uppercase mt-1">Committees</span>
</a>

<a onClick={() => navigate('/support')} className="flex flex-col items-center justify-center text-on-surface-variant opacity-70 hover:text-primary transition-opacity active:scale-90 duration-200 cursor-pointer" href="#">
<span className="material-symbols-outlined">contact_support</span>
<span className="font-label text-[12px] tracking-wide uppercase mt-1">Support</span>
</a>

<a onClick={() => navigate('/profile')} className="flex flex-col items-center justify-center text-on-surface-variant opacity-70 hover:text-primary transition-opacity active:scale-90 duration-200 cursor-pointer" href="#">
