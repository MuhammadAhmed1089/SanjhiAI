        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mt-8 text-center pt-8 border-t border-deep-navy/10">
            <p className="font-body text-[16px] text-on-surface-variant">
              ...
              <button className="font-label text-[14px] font-semibold text-teal-emerald hover:text-secondary underline underline-offset-4 decoration-2 decoration-teal-emerald/30 transition-all">
                Log in
              </button>
            </p>
          </div>
